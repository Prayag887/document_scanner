...
import com.ag.documentscanner.data.local.dao.PdfDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `pdfTable` (`pdfId` TEXT NOT NULL, `name` TEXT, `size` TEXT, `lastModifiedTime` INTEGER NOT NULL, PRIMARY KEY(`pdfId`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '43855a9810163f311dab6bce634cee37')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsPdfTable.put("name", new TableInfo.Column("name", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPdfTable.put("size", new TableInfo.Column("size", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoPdfTable.equals(_existingPdfTable)) {
          return new RoomOpenHelper.ValidationResult(false, "pdfTable(com.ag.documentscanner.data.model.Pdf).\n"
                  + " Expected:\n" + _infoPdfTable + "\n"
                  + " Found:\n" + _existingPdfTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "43855a9810163f311dab6bce634cee37", "bcc75bc0b8afb4949d5c5f122e67b0bd");
