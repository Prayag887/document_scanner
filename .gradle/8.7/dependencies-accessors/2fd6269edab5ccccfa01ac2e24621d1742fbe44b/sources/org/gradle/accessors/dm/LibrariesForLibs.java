...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final DocumentLibraryAccessors laccForDocumentLibraryAccessors = new DocumentLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>document</b>
     */
    public DocumentLibraryAccessors getDocument() {
        return laccForDocumentLibraryAccessors;
    }
    ...
    public static class DocumentLibraryAccessors extends SubDependencyFactory {

        public DocumentLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>scanner</b> with <b>com.google.android.gms:play-services-mlkit-document-scanner</b> coordinates and
         * with version reference <b>documentScanner</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getScanner() {
            return create("document.scanner");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>documentScanner</b> with value <b>16.0.0-beta1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDocumentScanner() { return getVersion("documentScanner"); }
        ...
        /**
         * Version alias <b>hiltPlugin</b> with value <b>2.52</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockwebserver</b> with value <b>4.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
